...
KERNEL_OBJ=$(OBJDIR)/kernel/console.o $(OBJDIR)/kernel/device/raspi2/display.o $(OBJDIR)/kernel/file.o $(OBJDIR)/kernel/device/raspi2/interrupts.o $(OBJDIR)/kernel/kernel.o $(OBJDIR)/kernel/kmalloc.o $(OBJDIR)/kernel/device/videocore/mailbox.o $(OBJDIR)/kernel/arch/aarch32/mmu.o $(OBJDIR)/kernel/arch/aarch32/processor.o $(OBJDIR)/kernel/stack.o $(OBJDIR)/kernel/tasks.o $(OBJDIR)/kernel/device/raspi2/timer.o $(OBJDIR)/kernel/device/pl011/uart.o
