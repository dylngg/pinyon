#pragma once
// Taken from https://github.com/rockytriton/LLD/blob/main/rpi_bm/part14/src/fontData.c
// which was borrowed from https://github.com/legionus/kbd (lat1-16 font)
// GPLv2+ licensed

namespace font {

constexpr auto width  = 8;
constexpr auto char_height = 16;
constexpr auto padding = 3;
constexpr auto height = char_height + padding;

static const unsigned char data[224][16] =
{
...
constexpr char start_ch = 0x21;

bool character_has_visible_pixel(char ch, unsigned x, unsigned y) {
    if (ch < start_ch)
        return false;
    if (y >= char_height)
        return false;
